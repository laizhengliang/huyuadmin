			...
			<div class="js-tabs-content">
				...
				<div>
					<fieldset>
                        ...
                        <div class="control-group">
							...
							<div class="controls">				
								<label class="radio inline"><input type="radio" value="0" name="post[service_switch]" <?php if(($config['service_switch']) == "0"): ?>checked="checked"<?php endif; ?>>关闭</label>
								<label class="radio inline"><input type="radio" value="1" name="post[service_switch]" <?php if(($config['service_switch']) == "1"): ?>checked="checked"<?php endif; ?>>开启</label>
						...
						<div class="control-group">
							...
							<div class="controls">				
								<input type="text" name="post[service_url]" value="<?php echo ($config['service_url']); ?>"> 注册链接：http://www.53kf.com/reg/index?yx_from=210260
							</div>
						</div>
				...
				<div>
					<fieldset>
                        ...
                        <div class="control-group">
							<label class="control-label">容联云ACCOUNT SID</label>
							<div class="controls">				
								<input type="text" name="post[ccp_sid]" value="<?php echo ($config['ccp_sid']); ?>"> 短信验证码 
							</div>
						</div>
                        
                        <div class="control-group">
							<label class="control-label">容联云AUTH TOKEN</label>
							<div class="controls">				
								<input type="text" name="post[ccp_token]" value="<?php echo ($config['ccp_token']); ?>"> 短信验证码 
							</div>
						</div>
                        
                        <div class="control-group">
							<label class="control-label">容联云应用APPID</label>
							<div class="controls">				
								<input type="text" name="post[ccp_appid]" value="<?php echo ($config['ccp_appid']); ?>"> 短信验证码 
							</div>
						</div>
                        
                        <div class="control-group">
							<label class="control-label">容联云短信模板ID</label>
							<div class="controls">				
								<input type="text" name="post[ccp_tempid]" value="<?php echo ($config['ccp_tempid']); ?>"> 短信验证码 
							</div>
						</div>
				...
				<div>
					<fieldset>
                        ...
                        <div class="control-group">
							<label class="control-label">发言等级限制</label>
							<div class="controls">				
								<input type="text" name="post[speak_limit]" value="<?php echo ($config['speak_limit']); ?>"> 0表示无限制
							</div>
						</div>
                        <div class="control-group">
							<label class="control-label">弹幕等级限制</label>
							<div class="controls">				
								<input type="text" name="post[barrage_limit]" value="<?php echo ($config['barrage_limit']); ?>"> 0表示无限制
							</div>
						</div>
                        
                        <div class="control-group">
							<label class="control-label">连麦等级限制</label>
							<div class="controls">				
								<input type="text" name="post[mic_limit]" value="<?php echo ($config['mic_limit']); ?>"> 0表示无限制
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls" id="sdk">
								<label class="radio inline"><input type="radio" value="0" name="post[live_sdk]" <?php if(($config['live_sdk']) == "0"): ?>checked="checked"<?php endif; ?>>直播模式</label>
								<label class="radio inline"><input type="radio" value="1" name="post[live_sdk]" <?php if(($config['live_sdk']) == "1"): ?>checked="checked"<?php endif; ?>>直播+连麦模式</label>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">CDN</label>
							<div class="controls" id="cdn">				
								<label class="radio inline"><input type="radio" value="1" name="post[cdn_switch]" <?php if($config['live_sdk'] == 1): ?>disabled<?php endif; ?> <?php if(($config['cdn_switch']) == "1"): ?>checked="checked"<?php endif; ?>>阿里云</label>
								...
								<label class="radio inline"><input type="radio" value="3" name="post[cdn_switch]" <?php if($config['live_sdk'] == 1): ?>disabled<?php endif; ?> <?php if(($config['cdn_switch']) == "3"): ?>checked="checked"<?php endif; ?>>七牛云</label>
								<label class="radio inline"><input type="radio" value="4" name="post[cdn_switch]" <?php if($config['live_sdk'] == 1): ?>disabled<?php endif; ?> <?php if(($config['cdn_switch']) == "4"): ?>checked="checked"<?php endif; ?>>网宿</label>
								<label class="radio inline"><input type="radio" value="5" name="post[cdn_switch]" <?php if($config['live_sdk'] == 1): ?>disabled<?php endif; ?> <?php if(($config['cdn_switch']) == "5"): ?>checked="checked"<?php endif; ?>>网易</label>
								<label class="radio inline"><input type="radio" value="6" name="post[cdn_switch]" <?php if($config['live_sdk'] == 1): ?>disabled<?php endif; ?> <?php if(($config['cdn_switch']) == "6"): ?>checked="checked"<?php endif; ?>>奥点云</label>
							</div>
						</div>
						<div>
							<div id="cdn_switch_1" class="hide" <?php if(($config['cdn_switch']) == "1"): ?>style="display:block;"<?php endif; ?>>
                                ...
                                <div class="control-group">
									<label class="control-label">推流鉴权KEY</label>
									<div class="controls">
										<input type="text" name="post[auth_key_push]" value="<?php echo ($config['auth_key_push']); ?>"> 推流鉴权KEY 留空表示不启用
									</div>
								</div>
                                <div class="control-group">
									<label class="control-label">推流鉴权有效时长</label>
									<div class="controls">
										<input type="text" name="post[auth_length_push]" value="<?php echo ($config['auth_length_push']); ?>"> 推流鉴权有效时长（秒）
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" name="post[auth_key_pull]" value="<?php echo ($config['auth_key_pull']); ?>"> 播流鉴权KEY 留空表示不启用
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" name="post[auth_length_pull]" value="<?php echo ($config['auth_length_pull']); ?>"> 播流鉴权有效时长（秒）
									</div>
								</div>
                                
                                <div class="control-group">
									<label class="control-label">阿里云AccessKey ID</label>
									<div class="controls">
										<input type="text" name="post[aliy_key_id]" value="<?php echo ($config['aliy_key_id']); ?>"> 回放用
									</div>
								</div>
                                <div class="control-group">
									<label class="control-label">阿里云AccessKey Secret</label>
									<div class="controls">
										<input type="text" name="post[aliy_key_secret]" value="<?php echo ($config['aliy_key_secret']); ?>"> 回放用
									</div>
								</div>
							</div>
					...
					<script>
					(function(){
						$("#sdk label.radio").on('click',function(){
							var v=$("input",this).val();
                            if(v==1){
                                $("#cdn label.radio input[type=radio]").attr('disabled','disabled');
                                $("#cdn label.radio input[type=radio][value=2]").removeAttr('disabled');
                                $("#cdn label.radio").eq(1).click();
                            }else{
                                $("#cdn label.radio input[type=radio]").removeAttr('disabled');
                            }
				...
				<div>
					<fieldset>
                        <div class="control-group">
							<label class="control-label">私信开关</label>
							<div class="controls">				
								<label class="radio inline"><input type="radio" value="0" name="post[letter_switch]" <?php if(($config['letter_switch']) == "0"): ?>checked="checked"<?php endif; ?>>关闭</label>
								<label class="radio inline"><input type="radio" value="1" name="post[letter_switch]" <?php if(($config['letter_switch']) == "1"): ?>checked="checked"<?php endif; ?>>开启</label>
								<label class="checkbox inline">关闭后用户间不可私信</label>
							</div>
						</div>
						<div class="control-group">
				...
				<div>
					<fieldset>
                        ...
                        <div class="control-group">
							<label class="control-label">苹果支付开关</label>
							<div class="controls">				
								<label class="radio inline"><input type="radio" value="0" name="post[ios_switch]" <?php if(($config['ios_switch']) == "0"): ?>checked="checked"<?php endif; ?>>关闭</label>
								<label class="radio inline"><input type="radio" value="1" name="post[ios_switch]" <?php if(($config['ios_switch']) == "1"): ?>checked="checked"<?php endif; ?>>开启</label>
								<label class="checkbox inline"></label>
							</div>
						</div>
						<div class="control-group">
