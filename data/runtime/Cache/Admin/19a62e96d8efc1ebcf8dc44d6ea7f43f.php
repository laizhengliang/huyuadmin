				...
				<div>
					<fieldset>
                        <div class="control-group">
							...
							<div class="controls">				
								<label class="radio inline"><input type="radio" value="0" name="post[isup]" <?php if(($config['isup']) == "0"): ?>checked="checked"<?php endif; ?>>关闭</label>
								<label class="radio inline"><input type="radio" value="1" name="post[isup]" <?php if(($config['isup']) == "1"): ?>checked="checked"<?php endif; ?>>开启</label>
							</div>
                        </div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<span class="form-required">二维码生成链接：<?php echo ($config['site']); ?>/index.php?g=Portal&m=index&a=scanqr</span>
							</div>
						</div>
