...
<html>
    ...
    <link href='/public/appapi/css/common.css?t=1561802353' rel="stylesheet" type="text/css" >
		...
		<title>我的分销</title>
		<link href='/public/appapi/css/agent.css?t=1561712925' rel="stylesheet" type="text/css" >
	</head>
<body >
	<div class="home">
        <div class="top_bg">
            <img src="/public/appapi/images/agent/agent_bg.png">
        </div>
        <div class="top_code">
            ...
            <ul>
                ...
                <li>
                    <a class="see" href="/index.php?g=Appapi&m=Agent&a=two&uid=<?php echo ($uid); ?>&token=<?php echo ($token); ?>">
                       ...
                       <span class="li_r color_default"><?php echo ($agnet_profit['two_profit']); ?></span>
                    </a>
                </li>
            </ul>
        </div>
