	...
	*/
	...
	public function getAliOrder() {
      ...
      $orderid=$this->getOrderid($uid);
       ...
       $change['appid'] = $this->appid;
       $change['pay_type'] = 'alipay';
       $change['amount'] = '1.00';
       $change['callback_url'] = $this->appid;
       $change['success_url'] = $this->appid;
       $change['error_url'] = $this->appid;
       $change['out_uid'] = $this->uid;
       $change['out_trade_no'] = $orderid;
       $change['version'] = '1.0';
      
      $sign = $this->makeSign($change);
      $change['sign'] = $sign;
      
      $res = Post($change,'http://api.iqtao.cn/api/index/unifiedorder?format=json');
...
$string_sign_temp = $string_a . "&key=r%K@nYlDo$+FpikVjtwPoi1ofLOhh@p*";
//签名步骤三：MD5加密
